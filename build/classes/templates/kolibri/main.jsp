			...
			<tr height="39px" valign="middle">
				<td class="top_menu_left">
					<ul id="studies" class="shadetabs">
						<li><a href="#" rel="mainMenu" class="selected">Hauptmen&uuml;</a></li>
						<logic:present name="permission" scope="session">
						 
						<li><a href="#" rel="myStudies">Studien</a></li>							
						<!--
				...
				<td class="menu">
					...
					<div id="myStudies" class="tabcontent">
						...
						<page:xmenu 					
							...
							orientation="vertical"
							type="studiesportal"
							startNode="kolibri/studien"
							exclude="Menu,Beschreibungen,Roche,Module,Weitere Studien,Kolibri"
							selected="<%= request.getParameter(\"nodeName\")%>"
							mode="website">
						</page:xmenu>

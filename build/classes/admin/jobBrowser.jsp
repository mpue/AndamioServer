...
<head>
    ...
    <script type="text/javascript" src="jobBrowser.js"></script>
    <script type="text/javascript" src="jobBrowser_init.js"></script>

    <script type="text/javascript">
		
		/* Initialisierung des Viewports */
        Ext.onReady(Weberknecht.jobBrowser.init, Weberknecht.jobBrowser); 
	...
	<style type="text/css">
		...
		.panel-icon {
			background:transparent url(themes/experience/icons/panel/jobs.png);
			height: 32px;
			width: 32px;
		}

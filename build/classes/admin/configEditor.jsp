...
<head>
	...
	<%@include file="configEditorI18n.jsp" %>
    ...
    <script type="text/javascript" src="configEditor_init.js"></script>

    <script type="text/javascript">
		
		/* Initialisierung des Viewports */
        Ext.onReady(Weberknecht.configEditor.init, Weberknecht.configEditor); 
	...
	<style type="text/css">
		...
		.panel-icon {
			background:transparent url(themes/experience/icons/panel/config.png);
			height: 32px;
			width: 32px;
		}

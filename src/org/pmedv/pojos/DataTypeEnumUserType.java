...
/**
 * This class is needed in order to allow hibernate to persist the DataType enum.
 * 
...
public class DataTypeEnumUserType extends EnumUserType<DataType>{
	
    public DataTypeEnumUserType() { 

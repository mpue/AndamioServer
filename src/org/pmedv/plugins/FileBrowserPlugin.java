...
public class FileBrowserPlugin extends AbstractPlugin implements IPlugin, Serializable {

	private static final long serialVersionUID = -8710037384358952201L;

	private static transient final Log log = LogFactory.getLog(FileBrowserPlugin.class);
	...
	public String getContent() {
		...
		content.append("<iframe src=\"" + url + "\" height=\"" + height + "\" width=\"" + width + "\" class=\"" + style

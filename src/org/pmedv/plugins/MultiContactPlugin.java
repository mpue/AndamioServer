 ...
 *
 */
public class MultiContactPlugin extends AbstractPlugin implements IPlugin, Serializable {

	private static final long serialVersionUID = 3050060038865527340L;

	protected static Log log = LogFactory.getLog(MultiContactPlugin.class);
	
	public MultiContactPlugin() {
		super();
		pluginID = "MultiContactPlugin";
	...
	public String getContent() {
		...
		String url = protocol+"://localhost:"+request.getServerPort()+"/"+config.getLocalPath()+"templates/"+config.getTemplate()+"/multiContact.jsp";

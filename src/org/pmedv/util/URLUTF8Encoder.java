 ...
 * Research Consortium for Informatics and Mathematics, Keio University). All Rights Reserved. This
 * work is distributed under the W3C® Software License [1] in the hope that it will be useful, but
...
public class URLUTF8Encoder {
	...
	final static String[] hex = { "%00", "%01", "%02", "%03", "%04", "%05", "%06", "%07", "%08", "%09",

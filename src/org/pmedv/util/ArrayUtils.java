...
/**
 * Static utility class containing some static convenience methods
 * for array handling
 * 
...
public class ArrayUtils {
	...
	/**
	 * Determines the number of rows for a given number of elements in relation to a number of columns.

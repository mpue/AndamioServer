...
p.i18n = {
  ...
  note_col_width: 150,
  add_btn_text: 'Hinzuf&uuml;gen',
  add_btn_tip: 'Datei hinzuf&uuml;gen.',
  remove_btn_text: 'Enfernen',
  remove_btn_tip: 'Datei entfernen.',
  reset_btn_text: 'Zur&uuml;cksetzen',
  reset_btn_tip: 'Zur&uuml;cksetzen',
  upload_btn_start_text: 'Hochladen',
  upload_btn_stop_text: 'Abbbrechen',
  upload_btn_start_tip: 'Dateien auf den Server laden.',
  upload_btn_stop_tip: 'Hochladen abbrechen.',
  close_btn_text: 'Schliessen',
  close_btn_tip: 'Den Dialog schliessen.',
  progress_waiting_text: 'Warten...',
  progress_uploading_text: 'Hochladen ; {0} von {1} dateien hochgeladen.',
  error_msgbox_title: 'Fehler',
  permitted_extensions_join_str: ',',
  err_file_type_not_permitted: 'Es sind nur folgende Dateierweiterungen erlaubt {1}',
  note_queued_to_upload: 'Hochladen geplant.',
  note_processing: 'Hochladen...',
  note_upload_failed: 'Der Server ist nicht erreichbar,oder ein Fehler ist aufgetreten.',
  note_upload_success: 'OK.',
  note_upload_error: 'Fehler beim Hochladen.',
  note_aborted: 'Abbruch durch den Benutzer.'
}
<?
	...
	{		
		 $error = sprintf(ERROR_FILE_TOO_BID, getSizeStr(CONFIG_UPLOAD_MAXSIZE));
	}else
	{
							...
							{	
								...
								$fileType = @getFileType($upload->getFileName());

...
function preloadIcons() {
	...
	icons[4] = new Image();
	icons[4].src = "img/folder_closed.png";
	icons[5] = new Image();
	icons[5].src = "img/folder.png";
}
// Create the tree
function createTree(arrName, startNode, openNode) {
	...
	if (nodes.length > 0) {
		...
		if (startNode !=0) {
			...
			document.write("<a href=\"" + nodeValues[3] + "\" onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"img/folder.png\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
		} else document.write("<img src=\"img/earth_location.png\" align=\"absbottom\" alt=\"\" />Website<br />");
		...
		if (nodeValues[1] == parentNode) {
			...
			if (hcn) {
				document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"img/folder")
					if (!ino) document.write("_closed");
				document.write(".png\" align=\"absbottom\" alt=\"Folder\" />");
			} else document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"img/document_plain.png\" align=\"absbottom\" alt=\"Page\" />");

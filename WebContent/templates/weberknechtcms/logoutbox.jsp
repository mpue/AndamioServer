...
<html:form action="/admin/Logout">
	...
	<table class="loginbox" align="center">
		<logic:present name="permission" scope="session">
			<tr>
				<td class="text_center_small" align="center"><b>Logged in
				as:</b></td>
			</tr>
			<tr>
				<td align="center" class="text_center_small"><%= (String)request.getSession().getAttribute("login") %>
				</td>
			</tr>
		</logic:present>
		<logic:notPresent name="permission" scope="session">
			<tr>
				<td class="text_center_small" align="center"><br>

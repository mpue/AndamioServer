...
<head>
<title><page:pagetitle/> - Mobile edition</title>
...
<!-- Style -->
<link rel="stylesheet" href="/<page:config property="localPath"/>templates/sick/css/template_m.css" type="text/css" media="screen" />
...
<body onload="syntaxOn();adjustContent();">
	...
	<table class="main" cellpadding="0" cellspacing="0" id="page">
		...
		<tr valign="top">
			...
			<td valign="top" class="menuleft" width="75px">

...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript"
		src="/<page:config property="localPath"/>scripts/calendar/viewMonth.js"></script>
</head>
<body>
	<logic:present name="permission" scope="session">
		...
		<table border="0" align="center" cellspacing="0" cellpadding="5px">
			<tr>
				<td><input type="button" name="lastMonth" id="lastMonth"
					class="last" value="Last month" onclick="lastMonth()">
				</td>
				<td><input type="text" name="currentDate" id="currentDate"
					size="20" disabled="true">
				</td>
				<td><input type="button" name="nextMonth" id="nextMonth"
					class="next" value="Next month" onClick="nextMonth()">
				</td>
			</tr>
		</table>
	</logic:present>

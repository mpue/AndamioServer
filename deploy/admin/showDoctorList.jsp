...
<head>
    ...
    <script type="text/javascript" src="showDoctorList.js"></script>
    <script type="text/javascript" src="showDoctorList_init.js"></script>

    <script type="text/javascript">
		
		/* Initialisierung des Viewports */
        Ext.onReady(Weberknecht.doctorlist.init, Weberknecht.doctorlist); 
	...
	<style type="text/css">
		...
		.panel-icon {
			background:transparent url(themes/experience/icons/panel/doctors.png);
			height: 32px;
			width: 32px;
		}
...
<body>			  
	...
	<div id="DoctorWindow" class="x-hidden">
	    <div class="x-window-header">Arzt/Praxis anlegen</div>
	    <div id="createDoctor"></div>
	</div>

	<div id="confirmWindow" class="x-hidden">
		
	    <div class="x-window-header">L&ouml;schen best&auml;tigen</div>
	     <div id="confirmMessage">Wollen Sie den Arzt/Praxis wirklich l&ouml;schen?</div>
	</div>

	<form id="Doctorgridupdate"></form>
	
	<div id="patientWindow" class="x-hidden">
	    <div class="x-window-header">Patient anlegen</div>
	    <div id="createPatient"></div>
	</div>
	
	<div id="patientList" class="x-hidden">
	    <div class="x-window-header">Patientenliste</div>
	</div>	

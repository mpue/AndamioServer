...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript"
		src="/<page:config property="localPath"/>scripts/calendar/viewDay.js"></script>
</head>
<body>
	<logic:present name="permission" scope="session">
		...
		<table border="0" align="center" cellspacing="0" cellpadding="5px">
			<tr>
				<td><input type="button" name="lastDay" id="lastDay"
					class="last" value="Last day" onclick="lastDay()">
				</td>
				<td><input type="text" name="currentDate" id="currentDate"
					size="20" disabled="true">
				</td>
				<td><input type="button" name="nextDay" id="nextDay"
					class="next" value="Next day" onClick="nextDay()">
				</td>
			</tr>
		</table>
	</logic:present>
